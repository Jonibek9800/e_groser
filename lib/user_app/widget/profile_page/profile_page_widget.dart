                    ...
                    child: InkWell(
                      onTap: () {
                        if (authModel.user != null) {
                          ...
                          Navigator.of(context).pushNamed(NavigationRouteNames.editProfile);
                        } else {
                          Navigator.of(context).pushNamed(NavigationRouteNames.loaderWidget);
                        }
                      },
                      child: Row(
                        children: [
                    ...
                    child: GridView(
                      ...
                      children: [
                        Card(
                          child: InkWell(
                            onTap: () {
                              ...
                              Navigator.of(context).pushNamed(NavigationRouteNames.allOrders);
                            },
                            child: Column(
                        ...
                        Card(
                          child: InkWell(
                            onTap: () {
                              Navigator.of(context).pushNamed(NavigationRouteNames.cartPage);
                            },
                            child: Column(
                              mainAxisAlignment: MainAxisAlignment.center,
                              children: [
                            ...
                            ? InkWell(
                                onTap: () {
                                  ...
                                  Navigator.of(context)
                                      .pushReplacementNamed(NavigationRouteNames.auth);
