...
import '../../../admin_bloc/slider_options_bloc/slider_bloc_event.dart';

class UpdatePosterWidget extends StatelessWidget {
  const UpdatePosterWidget({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Update Slider Poster"),
        centerTitle: true,
      ),
              ...
              children: [
                InkWell(
                  ...
                  child: posterModel.file != null
                      ...
                      : posterModel.poster?.poster != null
                          ? CachedNetworkImage(
                              imageUrl: posterModel.poster?.getPoster() ?? "",
                              height: 250,
                              progressIndicatorBuilder: (context, str, obj) =>
                                  const Center(
                          ...
                          children: [
                            FloatingActionButton.small(
                              ...
                              onPressed: () {
                                ...
                                pik.then((value) => context
                                    .read<SliderBloc>()
                                    .add(PicDateTimeEvent(
                            ...
                            SizedBox(
                                ...
                                child: Text(
                                  posterModel.dateStart != null
                                      ...
                                      : posterModel.poster?.startDate != null
                                          ? "${posterModel.poster?.startDate}"
                                          : "Без срока",
                                  maxLines: 2,
                            ...
                            SizedBox(
                                ...
                                child: Text(
                                  posterModel.dateEnd != null
                                      ...
                                      : posterModel.poster?.expirationDate !=
                                              null
                                          ? "${posterModel.poster?.expirationDate}"
                                          : "Без срока",
                                  maxLines: 2,
              ...
              child: Card(
                child: Padding(
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      context.read<SliderBloc>().add(UpdateSliderPosterEvent());
                      Navigator.of(context).pop();
                    },
                    child: const Text("Update Poster"),
                  ),
                ),
              ),
            )
